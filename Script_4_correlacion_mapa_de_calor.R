...
expresion <- read.csv("IHSM Subtropicals.csv", row.names = 1)
...
print(Mapa_calor)
ggsave("mapa de calor.jpg", Mapa_calor, width = 10, height = 10, units="in", dpi = 300)
dev.off()
...
Correlacion <- pheatmap(matriz_cor_genes,
         ...
         fontsize_col = 6)
print(Correlacion)
ggsave("correlacion.jpg", Correlacion, width = 10, height = 10, units="in", dpi = 300)
dev.off()
